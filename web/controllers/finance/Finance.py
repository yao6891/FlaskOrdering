...
from common.libs.Helper import i_pagination,select_filter_obj,get_dict_list_filter_field,get_dict_filter_field,get_current_date
...
def index():
    ...
    if pay_list:
        ...
        pay_order_items_map = get_dict_list_filter_field(PayOrderItem, PayOrderItem.pay_order_id, "pay_order_id", pay_order_ids)
